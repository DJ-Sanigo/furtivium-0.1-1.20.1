...
public class ModBlocks {
    ...
    public static final Block WARDENS_SNACK_CLUSTER = registerBlockWithoutItem("wardens_snack_cluster", new SculkBrambleBushBlock(AbstractBlock.Settings.copy(Blocks.SWEET_BERRY_BUSH).sounds(BlockSoundGroup.SCULK)));
